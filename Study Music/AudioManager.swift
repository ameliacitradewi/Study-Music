...
class AudioManager: NSObject, ObservableObject, AVAudioPlayerDelegate {
    ...
    @Published var songs: [Song] = [
        ...
        Song(songName: "Soon We'll Fly", composer: "Ghostrifter Official", audioFileName: "Soon We'll Fly.mp3", image: "9", copyrightInfo: "https://soundcloud.com/ghostrifter-official Creative Commons — Attribution-NoDerivs 3.0 Unported — CC BY-ND 3.0 Music promoted by https://www.chosic.com/free-music/all/ Image: https://www.pxfuel.com/"),
    ]
